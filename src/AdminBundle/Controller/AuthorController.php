...
class AuthorController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $authors = $em->getRepository('AdminBundle:Author')->findAll();
    ...
    {
        $author = new Author();
        $form = $this->createForm('AdminBundle\Form\AuthorType', $author);
    ...
    {
        $deleteForm = $this->createDeleteForm($author);
        $editForm = $this->createForm('AdminBundle\Form\AuthorType', $author);
